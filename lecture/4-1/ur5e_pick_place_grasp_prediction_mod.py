...
import sys
# sys.path.append('/isaac-sim/exts/omni.isaac.examples/')   # org
sys.path.append('/home/ailabktw/.local/share/ov/pkg/isaac_sim-2022.2.1/exts/omni.isaac.examples/')
...
model.to(device)
# model.load_state_dict(torch.load(os.path.join(Path(working_dir).parent, "checkpoint/model_99.pth")))  # org :
