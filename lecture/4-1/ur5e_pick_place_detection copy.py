...
my_controller2 = EndEffectorController(
    name="end_effector_controller", gripper=my_ur5.gripper, robot_articulation=my_ur5
    )
...
#             placing_position=observations[task_params['obj_0']["value"]]["target_position"],
