...
import sys
sys.path.append('/home/ailab/Workspace/minhwan/isaac_sim-2022.2.1/exts/omni.isaac.examples')
...
while simulation_app.is_running():
    ...
    if my_world.is_playing():
        ...
        # pic`king position을 앞서 grasp prediction에서 얻는 center 값의 world coordinate으로 설정
